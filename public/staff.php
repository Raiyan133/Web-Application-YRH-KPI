                      ...
                      <div class="p-5">
                        ...
                        <form class="form-group text-right">
                          ...
                          <div class="form row">
                            ...
                            <div class="col-sm-4">
                              <input class="form-control" id="staff_name" name="staff_name" type="text" autocomplete="off">
                            </div>
                            <div class="col-sm-2">
                              <span class="h7 text-gray-900 mb-4 form-text">นามสกุล :</span>
                            </div>
                            <div class="col-sm-4">
                              <input class="form-control" id="staff_surname" name="staff_surname" type="text" autocomplete="off">
                            </div>
                          </div>
                          ...
                          <div class="form row">
                            ...
                            <div class="col-sm-4">
                              <input class="form-control" id="staff_birthday" name="staff_birthday" type="text" autocomplete="off">
                            ...
                            <div class="col-sm-4">
                              <input class="form-control" id="staff_id_num" name="staff_id_num" type="text" autocomplete="off">
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                              <input class="form-control" id="staff_position" name="staff_position" type="text" autocomplete="off">
                            </div>
                          </div>
                          ...
                          <div class="form row">
                            ...
                            <div class="col-sm-4">
                              <input class="form-control" id="staff_username" name="staff_username" type="text" autocomplete="off">
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                              <input class="form-control" id="staff_password" name="staff_password" type="text" autocomplete="off">
                            </div>
                          </div>
                          ...
                          <div class="form row">
                            ...
                            <div class="col-sm-10">
                              ...
                              <button class="btn btn-secondary btn-user btn-block bg-gray-900" type="button" name="staff_action" id="staff_action"></button>
                            </div>
                          </div>
                        </form>
                      </div>
...
<script>
  $(document).ready(function() {
    ...
    function fetchStaff() {
      var staff_action = "staff_select";
      $.ajax({
        url: "staff_select.php",
        method: "POST",
        data: {
        ...
        success: function(data) {
          ...
          $('#staff_username').val('');
          $('#staff_password').val('');
          $('#staff_action').text('บันทึก');
          $('#result').html(data);
        }
      });
    }
    $('#staff_action').click(function() {
      ...
      var id = $('#num_id').val();
      var staff_action = $('#staff_action').text();
  ...
  function setData(id, data) {
    ...
    $('#staff_action').text("บันทึกการแก้ไข");
    $('#num_id').val(id);
