                      ...
                      <div class="p-5">
                        ...
                        <form class="form-group text-right">
                          <div class="form row">
                            ...
                            <div class="col-sm-10">
                              <input class="form-control" id="indicator_code" name="indicator_code" type="text" autocomplete="off">
                            </div>
                          </div>
                          ...
                          <div class="form row">
                            ...
                            <div class="col-sm-10">
                              <input class="form-control" id="indicator_name" name="indicator_name" type="text" autocomplete="off">
                            </div>
                          </div>
                          ...
                          <div class="form row">
                            ...
                            <div class="col-sm-10">
                              <input class="form-control" id="first_name" name="first_name" type="text" autocomplete="off">
                            </div>
                          </div>
                          ...
                          <div class="form row">
                            ...
                            <div class="col-sm-10">
                              <input class="form-control" id="last_name" name="last_name" type="text" autocomplete="off">
                            </div>
                          </div>

                          <?php include('../include/select_user.php');
                          if ($count_admin == 1) {
                          ?>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-4">
                                <select class="form-control" type="text" name="degree" id="degree" onChange="getTeam(this.value);">
                                  <option value="">โปรดเลือกระดับ</option>
                                  <?php
                                  $sql1 = "SELECT indicator.*, degree.* FROM indicator,degree WHERE degree.degree_id=indicator.degree AND team_code = '$username' LIMIT 1;";
                                  $results = $connect->query($sql1);
                                  while ($rs = $results->fetch_assoc()) {
                                  ?>
                                    <option value="<?php echo $rs["degree_id"]; ?>"><?php echo $rs["degree_name"]; ?></option>
                          ...
                          <div class="form row">
                            ...
                            <div class="col-sm-10">
                              ...
                              <button class="btn btn-secondary btn-user btn-block bg-gray-900" type="button" name="ind_action" id="ind_action"></button>
                            </div>
                          </div>
...
<script>
    ...
    function fetchIndicator() {
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          $('#degree').val('');
          $('#team').val('');
          $('#ind_action').text('บันทึก');
          $('#result').html(data);
        }
      });
    }
    $('#ind_action').click(function() {
      ...
      var team = $('#team').val();
      var id = $('#num_id').val();
      var ind_action = $('#ind_action').text();
  ...
  function setData(id, data) {
    $('#ind_action').text("บันทึกการแก้ไข");
    $('#num_id').val(id);
