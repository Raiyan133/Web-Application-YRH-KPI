      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <div class="row justify-content-center">
            ...
            <div class="col-xl-2 col-md-6 mb-4">
              <a href="home_degree_2.php" class="btn btn-secondary btn-icon-split align-items-center bg-gray-900" style="width:190px">
          ...
          <?php include('../include/homeinfo_degree_2.php'); ?>
        </div>
