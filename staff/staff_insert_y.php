                        ...
                        <form class="form-group text-right" method="post" name="form1" action="">
                          ...
                          if (isset($_POST['submit'])) {
                            ...
                            if (
                              ...
                              if (
                                is_numeric($number1) && is_numeric($divisor1)
                              ) {
                                ...
                                if ($divisor1 == '0') {
                                  ...
                                  $sql = "INSERT INTO graph_y (graph_y_id, indicator, year, number1, divisor1) VALUES ('$id','$ind_code','$year','$number1','$divisor1')";
                          ...
                          ?>
                                    <script type="text/javascript">
                                      window.location = "staff_insert_y_graph.php";
                                    </script>
                          <?php
                                  } else {
