                        ...
                        <form class="form-group text-right" method="post" name="form1" action="">
                          ...
                          ?>
                            <script type="text/javascript">
                              window.location = "staff_insert_6m_edit.php";
                            </script>
                            <?php
                          } else if (isset($_POST['submit1'])) {
                            $comment1 = $_POST['comment'];
                            $sql = "UPDATE graph_6m SET comment='$comment1',user_post='$username'  WHERE graph_6m_id='$id'";
                            if ($connect->query($sql) === TRUE) {
                            ?>
                              <script type="text/javascript">
                                window.location = "staff_insert_6m_success.php";
                              </script>
                          <?php
                            }
                          }
