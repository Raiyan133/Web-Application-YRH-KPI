...
include('../staff/staff_include/select_graph_3m.php');
?>
                        ...
                        <form class="form-group text-right" method="post" name="form1" action="">
                          ...
                          ?>
                            <script type="text/javascript">
                              window.location = "staff_insert_3m_edit.php";
                            </script>
                            <?php
                          } else if (isset($_POST['submit1'])) {
                            $comment1 = $_POST['comment'];
                            $sql = "UPDATE graph_3m SET comment='$comment1',user_post='$username' WHERE graph_3m_id='$id'";
                            if ($connect->query($sql) === TRUE) {
                            ?>
                              <script type="text/javascript">
                                window.location = "staff_insert_3m_success.php";
                              </script>
                          <?php
                            }
                          }
