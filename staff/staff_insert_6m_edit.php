...
include('../staff/staff_include/select_graph_6m.php');
?>
                        ...
                        <form class="form-group text-right" method="post" name="form1" action="">
                            ...
                            if (
                              ...
                              if (
                                ...
                                if ($divisor1 == '0' || $divisor2 == '0') {
                                  ...
                                  $sql = "UPDATE graph_6m SET number1='$number1', number2='$number2', divisor1='$divisor1', divisor2='$divisor2' 
                                  WHERE graph_6m_id='$id'";
                          ...
                          <table class="table table-borderless text-gray-800">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <th>ตัวตั้ง</th>
                                <td align="center"><input class="form-control" name="number1" id="number1" type="text" value="<?php echo $number1; ?>" style="width:130px"></td>
                                <td align="center"><input class="form-control" name="number2" id="number2" type="text" value="<?php echo $number2; ?>" style="width:130px"></td>
                              </tr>
                              <tr>
                                <th>ตัวหาร</th>
                                <td align="center"><input class="form-control" name="divisor1" id="divisor1" type="text" value="<?php echo $divisor1; ?>" style="width:130px"></td>
                                <td align="center"><input class="form-control" name="divisor2" id="divisor2" type="text" value="<?php echo $divisor2; ?>" style="width:130px"></td>
                              </tr>
                            </tbody>
                          </table>
                          <div class="form row">
