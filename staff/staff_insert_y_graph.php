...
include('../staff/staff_include/select_graph_y.php');
?>
                        ...
                        <form class="form-group text-right" method="post" name="form1" action="">
                          ...
                          ?>
                            <script type="text/javascript">
                              window.location = "staff_insert_y_edit.php";
                            </script>
                            <?php
                          } else if (isset($_POST['submit1'])) {
                            $comment1 = $_POST['comment'];
                            $sql = "UPDATE graph_y SET comment='$comment1',user_post='$username'  WHERE graph_y_id='$id'";
                            if ($connect->query($sql) === TRUE) {
                            ?>
                              <script type="text/javascript">
                                window.location = "staff_insert_y_success.php";
                              </script>
                          <?php
                            }
                          }
                          ...
                          <table class="table table-borderless text-gray-800">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <th>ตัวตั้ง</th>
                                <td align="center"><input class="form-control" name="number1" id="number1" type="text" value="<?php echo $number1; ?>" style="width:150px" readonly></td>
                              </tr>
                              <tr>
                                <th>ตัวหาร</th>
                                <td align="center"><input class="form-control" name="divisor1" id="divisor1" type="text" value="<?php echo $divisor1; ?>" style="width:150px" readonly></td>
                              </tr>
                            </tbody>
                          </table>
