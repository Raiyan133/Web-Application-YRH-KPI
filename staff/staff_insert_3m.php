                        ...
                        <form class="form-group text-right" method="post" name="form1" action="">
                            ...
                            if (
                              ...
                              if (
                                ...
                                if ($divisor1 == '0' || $divisor2 == '0' || $divisor3 == '0' || $divisor4 == '0') {
                                  ...
                                  $sql = "INSERT INTO graph_3m (graph_3m_id, indicator, year, number1, number2, number3, number4, divisor1, divisor2, divisor3, divisor4) 
                                  VALUES ('$id','$ind_code','$year','$number1','$number2','$number3','$number4', '$divisor1','$divisor2','$divisor3','$divisor4')";
                          ...
                          ?>
                                    <script type="text/javascript">
                                      window.location = "staff_insert_3m_graph.php";
                                    </script>
