                      ...
                      <div class="p-5">
                        ...
                        <form class="form-group text-right" method="post" name="form1" action="" onSubmit="JavaScript:return fncSubmit();">
                          ...
                          <div class="form row">
                            ...
                            <div class="col-sm-6">
                              <input class="form-control" type="text" value="6 เดือน" readonly>
                            </div>
                          </div>
                          ...
                          <div class="form row">
                            ...
                            <div class="col-sm-2">
                              <select class="form-control" name="select1" id="select1">
                                ...
                                <?php include('../admin/admin_include/select_year_graph_6m.php'); ?>
                              </select>
                            </div>
                          </div>
                          ...
                          <div class="form row">
                            ...
                            <div class="col-sm-2">
                              <?php
                              if (mysqli_num_rows($objQuery) > 4) {
                              ?>
                                <a href="../admin/admin_compare_6m_5.php" class="btn btn-secondary btn-user btn-block bg-gray-900" style="width:100%">
                          ...
                          if (isset($_POST['submit'])) {
                            if (!empty($_POST['select1']) && !empty($_POST['select2']) && !empty($_POST['select3']) && !empty($_POST['select4'])) {
                          ...
                          ?>
                                <script type="text/javascript">
                                  window.location = "admin_compare_6m_4graph.php";
                                </script>
                          <?php
                              } else {
