...
include('../admin/admin_include/select_compare_graph_3m_1.php');
include('../admin/admin_include/select_compare_graph_3m_2.php');
include('../admin/admin_include/select_compare_graph_3m_3.php');
include('../admin/admin_include/select_compare_graph_3m_4.php');
include('../admin/admin_include/select_compare_graph_3m_5.php');
?>
