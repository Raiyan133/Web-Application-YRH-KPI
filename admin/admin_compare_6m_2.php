                      ...
                      <div class="p-5">
                        ...
                        <form class="form-group text-right" method="post" name="form1" action="" onSubmit="JavaScript:return fncSubmit();">
                          ...
                          <div class="form row">
                            ...
                            <div class="col-sm-2">
                              <?php
                              if (mysqli_num_rows($objQuery) > 2) {
                              ?>
                                <a href="../admin/admin_compare_6m_3.php" class="btn btn-secondary btn-user btn-block bg-gray-900" style="width:100%">
