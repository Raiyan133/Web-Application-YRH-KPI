                        ...
                        <form class="form-group text-right" method="post" name="form1" action="">
                          ...
                          <div class="row justify-content-center">
                            <div class="col-xl-3 col-md-6 mb-2">
                              <a href="../admin/admin_managehome.php" class="btn btn-secondary btn-user btn-block bg-gray-900" style="width:100%">
                                <span class="text">
                            ...
                            <div class="col-xl-1 col-md-6 mb-2">
                              <div class="btn btn-block bg-gray-100">
                                <a href="admin_managehome_view.php?active=<?= $graph_id ?> "><img src="../img/active.png" width="25" height="25" /></a>
                              </div>
                            </div>
                            ...
                            <div class="col-xl-1 col-md-6 mb-2">
                              <div class="btn btn-block bg-gray-100">
                                <a href="admin_managehome_view.php?non_active=<?= $graph_id ?>"><img src="../img/active_non.png" width="25" height="25" /></a>
                              </div>
                            </div>
                          </div>
                        </form>
