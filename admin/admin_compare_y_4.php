                      ...
                      <div class="p-5">
                        ...
                        <form class="form-group text-right" method="post" name="form1" action="" onSubmit="JavaScript:return fncSubmit();">
                          ...
                          <div class="form row">
                            ...
                            <div class="col-sm-6">
                              <input class="form-control" type="text" value="รายปี" readonly>
                            </div>
                          </div>
                          ...
                          <div class="form row">
                            ...
                            <div class="col-sm-2">
                              <select class="form-control" name="select1" id="select1">
                                ...
                                <?php include('../admin/admin_include/select_year_graph_y.php'); ?>
                              </select>
                            </div>
                          </div>
                          ...
                          <div class="form row">
                            ...
                            <div class="col-sm-2">
                              ...
                              ?>
                                <a href="../admin/admin_compare_y_5.php" class="btn btn-secondary btn-user btn-block bg-gray-900" style="width:100%">
                          ...
                          ?>
                                <script type="text/javascript">
                                  window.location = "admin_compare_y_4graph.php";
                                </script>
                          <?php
                              } else {
