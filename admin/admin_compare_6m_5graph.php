...
include('../admin/admin_include/select_compare_graph_6m_1.php');
include('../admin/admin_include/select_compare_graph_6m_2.php');
include('../admin/admin_include/select_compare_graph_6m_3.php');
include('../admin/admin_include/select_compare_graph_6m_4.php');
include('../admin/admin_include/select_compare_graph_6m_5.php');
?>
